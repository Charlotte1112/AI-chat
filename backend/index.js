...
const MODEL_ID = process.env.VITE_XUNFEI_MODEL_ID || 'xopqwen35v35b';
...
const server = http.createServer((req, res) => {
  ...
  // 只处理POST请求到/api/chat、/api/v2 或 /chat
  if (req.method === 'POST' && ['/api/chat', '/api/v2', '/chat'].includes(req.url)) {
    let body = '';
